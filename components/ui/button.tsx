  ...
  ({ children, icon, secondary, light, className, small, onClick }, ref) => {
    ...
    return (
      <button
        ...
        onClick={onClick}
        className={twMerge(
          "bg-transparent outline-none px-4 py-[10px] border text-blue-primary uppercase justify-center xs:justify-start font-kumbh font-semibold tracking-[.25rem] flex gap-x-4 items-center [&>svg]:w-[20px]",
          secondary
            ? light
