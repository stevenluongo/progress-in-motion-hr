    ...
    <section className="h-screen grid place-items-center">
      ...
      <TextContainer className="z-10 max-w-[500px] md:items-center px-8">
        ...
        <button
          ...
          className="flex bg-red-50 text-white bg-transparent border border-white px-4 py-2  md:px-8 md:py-4 text-xs md:text-sm uppercase leading-body items-center gap-x-2 md:gap-x-4 tracking-[.245rem] font-[700]"
        >
          Explore{" "}
